...
def train(config, train_loader, model, criterion, optimizer, epoch,
    ...
    i = 0
    for (input, target, target_weight, meta) in tqdm(iter(train_loader)):
...
def validate(args, config, val_loader, val_dataset, model, criterion, output_dir,
    ...
    with torch.no_grad():
        ...
        name_values, perf_indicator = val_dataset.evaluate(
            args, config, all_preds, output_dir, all_boxes, image_path, filenames, imgnums)
